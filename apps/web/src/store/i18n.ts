...
const translations: Record<Locale, Record<string, string>> = {
    ru: {
        ...
        'setup.large': 'Большой',
        'setup.mini_label': 'Мини (13)',
        'setup.standard_label': 'Стандарт (25)',
        'setup.large_label': 'Большой (41)',
        'setup.pvp': 'PvP',
    ...
    en: {
        ...
        'setup.large': 'Large',
        'setup.mini_label': 'Mini (13)',
        'setup.standard_label': 'Standard (25)',
        'setup.large_label': 'Large (41)',
        'setup.pvp': 'PvP',
        'setup.single': 'Single',
        'setup.easy': 'Easy',
        'setup.medium': 'Medium',
