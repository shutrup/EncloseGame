...
export function GameScreen() {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="fixed inset-0 mx-auto flex w-full max-w-[900px] flex-col overflow-hidden px-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] pt-[calc(env(safe-area-inset-top)+2.5rem)]"
    >
      <motion.header
        initial={false}
        animate={{ opacity: 1 }}
